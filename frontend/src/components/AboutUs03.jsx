...
const AboutUs03 = () => {
  return (
    <section className="relative isolate overflow-hidden bg-[#FFFFFF]">
      <div className="absolute inset-x-0 top-0 h-48 bg-gradient-to-b from-[#EDEEEB] to-transparent" />
      <div className="absolute inset-y-0 right-0 w-1/3 translate-x-1/3 bg-gradient-to-l from-[#CCC7BF]/50 to-transparent blur-3xl" />
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col justify-center items-center px-6 sm:px-8 md:px-10 pt-12 pb-16">
        <div className="text-center">
          <h1 className="text-2xl md:text-3xl font-bold mb-4 text-[#31393C]">
          Beginning of a Transformative Era.
        </h1>
          <p className="text-[#31393C]/75 leading-relaxed mb-8 text-left text-sm sm:text-base">
          ...
          {/* Career Options */}
          <h2 className="text-xl font-semibold text-[#31393C] mb-4">
            Career Options
          </h2>
          ...
          <div className="flex justify-center items-center gap-3">
            <a
              ...
              className="flex items-center gap-2 bg-[#25D366] hover:bg-[#1DA653] text-white px-5 py-2.5 rounded-full transition duration-300 shadow-md"
            >
              <svg
